...
const AboutHero = () => {
  ...
  const heroMutation = useMutation({
    mutationFn: async () => api.put("/about/main/hero", { heroHeading, heroSubheading }),
    onSuccess: () => {
      heroFlash.flash();
  ...
  return (
    <div className="space-y-6 max-w-4xl pb-10">
      <div className="bg-dark-800 p-6 rounded-3xl mb-6 shadow-sm border border-surface-border">
        <h1 className="text-2xl font-bold text-white">About Us — Hero Section</h1>
        <p className="text-gray-400 text-sm mt-1">Manage the hero content for the About page.</p>
      </div>
