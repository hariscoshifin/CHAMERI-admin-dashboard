...
const KiwanoAmenities = () => {
  ...
  const mutation = useMutation({
    mutationFn: async () => {
      return api.put("/kiwano/main/amenities-section", { heading, subheading });
    },
    onSuccess: () => {
      flash.flash();
  ...
  return (
    <div className="space-y-6 max-w-4xl pb-10">
      <div className="bg-dark-800 p-6 rounded-3xl mb-6 shadow-sm border border-surface-border">
        <h1 className="text-2xl font-bold text-white">Kiwano — Amenities Section</h1>
...
export default KiwanoAmenities;
